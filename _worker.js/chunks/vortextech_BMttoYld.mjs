...
const id = "en/vortextech.mdoc";
						const collection = "works";
						const slug = "en/vortextech";
						...
						const data = {title:"VortexTech Dynamics",pubDate:new Date(1701129600000),lastUpdateDate:new Date(1708387200000),cover:
						new Proxy({"src":"/_astro/cover.BZ5o4vAQ.jpg","width":768,"height":1152,"format":"jpg","fsPath":"C:/Users/polbu/DEV/mercuriumlandingpage/mercuriumlandingpage/src/assets/works/vortextech/cover.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/polbu/DEV/mercuriumlandingpage/mercuriumlandingpage/src/assets/works/vortextech/cover.jpg";
							}
							
							return target[name];
						}
					})
					,description:"Pioneering quantum-enhanced fluid dynamics simulation for aerospace and marine applications.",link:"https://vortextech-dynamics.io",tags:["Quantum Computing","Fluid Dynamics","Aerospace","Maritime Engineering"]};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/polbu/DEV/mercuriumlandingpage/mercuriumlandingpage/src/content/works/en/vortextech.mdoc",

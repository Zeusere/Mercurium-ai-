...
const id = "en/skywardtech.mdoc";
						...
						new Proxy({"src":"/_astro/cover.D_pWQcN_.jpg","width":1080,"height":1082,"format":"jpg","fsPath":"C:/Users/polbu/DEV/mercuriumlandingpage/mercuriumlandingpage/src/assets/works/skywardtech/cover.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/polbu/DEV/mercuriumlandingpage/mercuriumlandingpage/src/assets/works/skywardtech/cover.jpg";
							}

...
const id = "it/about.mdoc";
						...
						const data = {title:"Chi siamo",type:"informational",lastUpdateDate:new Date(1709942400000),hideTitle:false,seo:{title:"Chi siamo | Your Company Studio",description:"Siamo uno studio digitale che crea siti web e applicazioni belli e funzionali.",author:"Your Company"}};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/polbu/DEV/mercuriumlandingpage/mercuriumlandingpage/src/content/pages/it/about.mdoc",
							rawData: "\r\ntitle: Chi siamo\r\ntype: informational\r\nlastUpdateDate: 2024-03-09\r\nhideTitle: false\r\naddPadding: false\r\nseo:\r\n  title: Chi siamo | Your Company Studio\r\n  description: Siamo uno studio digitale che crea siti web e applicazioni belli e funzionali.\r\n  author: Your Company\r",
						};
